public class ErrorLog {
	...
	public boolean containsKey(String keyword) {
        ...
        String k2 = keyword + " ";
        String k3 = " " + keyword;
        if(description.indexOf(k1) != -1) return true;
        if(description.indexOf(k2) == 0) return true;
        if(description.indexOf(k3) == description.length() - (keyword.length()+1)) return true;
